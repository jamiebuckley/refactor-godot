...
TEST_CASE( "Query position by ID", "[Grid]" ) {
    auto grid = Refactor::Grid(5, new FakeGodotInterface());
    auto entity = grid.add_entity(1, 1,godot::Vector3(0, 0, 0), Refactor::EntityType::WORKER, nullptr);
...
TEST_CASE( "Step moves workers", "[Grid]" ) {
    auto grid = Refactor::Grid(5, new FakeGodotInterface());
    auto entity = grid.add_entity(0, 0, godot::Vector3(0, 0, 1), Refactor::EntityType::WORKER, nullptr);
    grid.step();
    auto coords = grid.get_entity_coordinates(entity->getId());
...
TEST_CASE( "Workers block worker", "[Grid]" ) {
    ...
    auto entity1 = grid.add_entity(0, 0, godot::Vector3(0, 0, 1), Refactor::EntityType::WORKER, nullptr);
    auto entity2 = grid.add_entity(0, 1, godot::Vector3(0, 0, 1), Refactor::EntityType::WORKER, nullptr);
    grid.step();
...
TEST_CASE( "Blocking cascades", "[Grid]" ) {
    ...
    auto entity1 = grid.add_entity(0, 0, godot::Vector3(0, 0, 1), Refactor::EntityType::WORKER, nullptr);
    auto entity2 = grid.add_entity(0, 1, godot::Vector3(0, 0, 1), Refactor::EntityType::WORKER, nullptr);
    auto entity3 = grid.add_entity(0, 2, godot::Vector3(0, 0, 1), Refactor::EntityType::WORKER, nullptr);
    grid.step();
    ...
    auto coords3 = grid.get_entity_coordinates(entity1->getId());
...
TEST_CASE( "Move onto vacated square", "[Grid]" ) {
    auto grid = Refactor::Grid(2, new FakeGodotInterface());
    auto entity1 = grid.add_entity(0, 0, godot::Vector3(0, 0, 1), Refactor::EntityType::WORKER, nullptr);
    auto entity2 = grid.add_entity(0, 1, godot::Vector3(1, 0, 0), Refactor::EntityType::WORKER, nullptr);
    grid.step();
